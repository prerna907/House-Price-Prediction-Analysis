> **Tip:** If GitHub fails to render the notebook, [View it directly on nbviewer](https://nbviewer.org/github/prerna907/House-Price-Prediction-Analysis/blob/main/SalesAssignment.ipynb)
